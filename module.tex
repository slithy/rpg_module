...
environment \texttt{minipageonecol}.\\[0.5em]

\section*{Wandering Monsters}

% maybe need a \newcolumntype (from array package) to give a number which counts from a specified starting number (see enumerated columns)
% wandering monster table can use that type

%\newcommand\underlinecol[1]{\foreach \c in {1,...,#1}{\cmidrule(l{\tabcolsep}r{\tabcolsep}){\c-\c}}}

\begin{center}
\begin{tabular}{c l c c c c c c c c c}
\bfseries Die Roll & \bfseries\centering Wandering Monster & \bfseries No. & \bfseries AC & \bfseries HD & \bfseries MV & \bfseries Attacks & \bfseries Damage & \bfseries Save & \bfseries ML & \bfseries AL\\
...
\cmidrule(l{\tabcolsep}r{\tabcolsep}){6-6}
\cmidrule(l{\tabcolsep}r{\tabcolsep}){7-7}
\cmidrule(l{\tabcolsep}r{\tabcolsep}){8-8}
\cmidrule(l{\tabcolsep}r{\tabcolsep}){9-9}
\cmidrule(l{\tabcolsep}r{\tabcolsep}){10-10}
\cmidrule(l{\tabcolsep}r{\tabcolsep}){11-11}
