...
\item Type, e.g. ``Dragon'', ``Lycanthrope'' or ``Man''. Leave blank for monsters which don't have a type.
...
\item Morale
\item Alignment. List the long form, e.g. ``Chaotic''. The short form is computed where required. In case of monsters with variable alignment, use the
\verb|\Alignment| macro here and redefine the macro as needed in the text.
...
\monster[Minions of Set]{minion_set}{Minion of Set}{|0|5**|120'|40'||||1|weapon or bite or by form|1--8 or 1--12+poison|1--8 or 1--12+poison or by form|Fighter: 10|12|Chaotic|1--6|1--20|Nil|425}

\noindent\texttt{\textbackslash monster[Minions~of~Set]\{minion\_set\}\{Minion~of~Set\}\{|0|
5**|120'|40'||||1|weapon~or~bite~or~by~form|
1--8~or~1--12+poison|1--8~or~1--12+poison~or~by~form|
...
Finally, there is the \verb|statblockfreestyle| environment, which is provided for monsters which don't fit easily into the standard
template. This may be suitable for NPCs or other non-standard encounters. The module class includes additional \verb|ifbasicstats|
and \verb|ifadvancedstats| macros to allow you to create stats for your NPCs across several RPG systems. Here is an example:
...
\wanderitem{gnoll}{}
\renewcommand{\Alignment}{Chaotic}% Change the alignment of Acolytes from ``Any'' to ``Chaotic''
\wanderitem{acolyte}{}
\wanderitem{minion_set}{1}
\wanderitem{harpy}{}
\wanderitem{kobold}{}
\wanderitem{bat}{}
...
\ref{inner_sanctuary} & Snefru-hotep & 1 & 5 & C5 & 21 & 30' & mace & 1--6 & C5 & 11 & C\\
\rosteritem{\ref{inner_sanctuary}}{minion_set}{4}{25 each}
\rosteritem{test}{bat}{4}{25 each}
\end{monsterroster}
\end{onecolumnfloat}
