...
RPG system. In principle, authors will be able to compile their work with stats for different systems simply by changing the option
paseed to \verb|documentclass|.

See p.\pageref{stat_blocks} for more detail on monster stat blocks.
