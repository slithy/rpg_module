...
\newcommand\tableheader[2][\relax]{%
   \newcolumntype{h}{>{\centering#1}c}
   {\StrCount{\noexpand#2}{&}[\numamps]\global\setcounter{numcols@module}{\numamps}\stepcounter{numcols@module}}
%   {\StrSubstitute[1]{\noexpand#2}{&}{\rbracetoken &}[\tableheader]
%   \gdef\headerrow{\multicolumn{1}{h}\lbracetoken\noexpand\tableheader}
%}
%\headerrow
% \gdef\tableheader@module

% I want to do something here like split the string into substrings (StrSplit?) and process each one individually
#2\\
