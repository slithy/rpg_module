...
\item Attacks (short form)
\item Attacks (long form)
\item Damage (short form)
\item Damage (long form)
\item Save As
\item Morale
\item Alignment
\item No. Appearing (wandering monster)
\item No. Appearing in Lair
\item Treasure Type
\end{itemize}

\noindent For example, suppose we create the following definition:\\[0.1em]

\monster[Minions of Set]{minion_set}{Minion of Set}{|0|5**|120'|40'||||weapon/bite|1 weapon or by form|1--8/1--12 + poison|1--8 or 1--12 + poison or by form|Fighter: 10|12|Chaotic|1--6|1--20|Nil|425}

\noindent\texttt{\textbackslash monster[Minions~of~Set]\{minion\_set\}\{Minion~of~Set\}\{0|
5*|120'|40'|weapon/bite|1~weapon~or~by~form|
1--8/1--12~+~poison|1--8~or~1--12~+~poison~or~by~form|
Fighter:~10|12|Chaotic|1--6|1--20|Nil\}}\\[0.1em]

\noindent Now we can use definitions like this:
\begin{quote}
\verb|\statblock{minion_set}{4}{25 each}|
\end{quote}
to produce stat blocks like this:
